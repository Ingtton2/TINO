 ...
 */
public class ExampleUnitTest extends AppCompatActivity implements AlarmAdapter.CallBack {
    ...
    private void sendIntent(Alarm alarm, String intentType) {
        ...
        Intent intent1 = new Intent(ExampleUnitTest.this, AlarmReceiver.class);
    ...
    private void setAlarm(Alarm alarm, int flags) {
        ...
        Intent intent = new Intent(ExampleUnitTest.this, AlarmReceiver.class);
        ...
        PendingIntent alarmIntent = PendingIntent.getBroadcast(ExampleUnitTest.this, alarmId,
                intent, flags);
    ...
    private void deleteCancel(Alarm alarm) {
        ...
        PendingIntent alarmIntent = PendingIntent.getBroadcast(ExampleUnitTest.this, alarmId, intent, 0);
